...
| Project Type | Technologies | Turnaround |
|---|---|---|
| Restaurant/Café Websites | HTML, CSS, JS | 5–7 days |
| Business Landing Pages | React, Tailwind | 3–5 days |
| Portfolio Websites | HTML, CSS, JS | 3–5 days |
| SaaS Landing Pages | Tailwind, JS | 5–7 days |
...
**Styling:** Tailwind CSS • Responsive Design • CSS Animations
**Tools:** Git • GitHub • VS Code • Figma
**Learning:** React Hooks • Node.js • TypeScript
